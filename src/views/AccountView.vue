        ...
        <div class="col-12 col-md-7 col-lg-9 container">
          ...
          <div class="tez-information text">
            <div class="row g-3 align-items-center information ">
              ...
              <div class="col-10 col-md-10 col-lg-5">
                <input type="text" id="name" class="form-control" aria-describedby="passwordHelpInline"
                  :placeholder="`${this.profile.firstname} ${this.profile.lastname}`" disabled>
              </div>
            </div>
            ...
            <div class="row g-3 align-items-center information ">
              ...
              <div class="col-10 col-md-10 col-lg-5">
                <input type="text" class="form-control" aria-describedby="passwordHelpInline"
                  :placeholder="`${this.profile.email}`" disabled>
              </div>
            </div>
            ...
            <div class="row g-3 align-items-center information ">
              ...
              <div class="col-10 col-md-10 col-lg-5">
                <input type="text" class="form-control" aria-describedby="passwordHelpInline"
                  :placeholder="`${this.profile.phone}`" disabled>
              </div>
            </div>
            ...
            <div class="row g-3 align-items-center information ">
              ...
              <div class="col-10 col-md-10 col-lg-5">
                <input type="text" class="form-control" aria-describedby="passwordHelpInline"
                  :placeholder="`${this.profile.username}`" disabled>
              </div>
            </div>
            ...
            <div class="row g-3 align-items-center information ">
              ...
              <div class="col-10 col-md-10 col-lg-5">
                <input type="text" class="form-control" aria-describedby="passwordHelpInline"
                  :placeholder="`${this.profile.facebook}`" disabled>
              </div>
            </div>
            ...
            <div class="row g-3 align-items-center information ">
              ...
              <div class="col-10 col-md-10 col-lg-5 ">
                <input type="text" class="form-control" aria-describedby="passwordHelpInline"
                  :placeholder="`${this.profile.twitter}`" disabled>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="tez-form bg-white">
              <h1 class="text-center tez-form-header tez-form-header-2"> Edit <span class="tez-form-header"> Profile
                </span>
              </h1>
              <form action="#">
                <div class="mb-3 mt-3 tez-form-text">
                  <label for="fname">First Name</label>
                  <input type="fname" class="form-control" :placeholder="`${this.edit_temp.firstname}`"
                    v-model="this.edit_temp.firstname">
                </div>
                <div class="mb-3 mt-3 tez-form-text">
                  <label for="lname">Last Name</label>
                  <input type="lname" class="form-control" :placeholder="`${this.edit_temp.lastname}`"
                    v-model="this.edit_temp.lastname">
                </div>
                <div class="mb-3 mt-3 tez-form-text">
                  <label for="username">Username</label>
                  <input type="username" class="form-control" :placeholder="`${this.edit_temp.username}`"
                    v-model="this.edit_temp.username">
                </div>
                <div class="mb-3 mt-3 tez-form-text">
                  <label for="link">Phone</label>
                  <input type="link" class="form-control" :placeholder="`${this.edit_temp.phone}`"
                    v-model="this.edit_temp.phone">
                </div>
                <div class="mb-3 mt-3 tez-form-text">
                  <label for="link">Facebook</label>
                  <input type="link" class="form-control" :placeholder="`${this.edit_temp.facebook}`"
                    v-model="this.edit_temp.facebook">
                </div>
                <div class="mb-3 mt-3 tez-form-text">
                  <label for="link">Twitter</label>
                  <input type="link" class="form-control" :placeholder="`${this.edit_temp.twitter}`"
                    v-model="this.edit_temp.twitter">
                </div>
                <div class="mb-3 mt-3 tez-form-text">
                  <label for="formFileSm" class="form-label">Picture</label>
                  <input type="file" accept="image/*" class="form-control form-control-sm " style="opacity:0.5;height:10;"
                    @change="uploadImage($event)" id="file-input" :disabled="!isUploaded">
                </div>
                <button type="button" class="btn btn-primary mt-3 tez-btn tez-form-btn" data-bs-dismiss="modal"
                  @click="updateUser()" :disabled="!isUploaded"> Confirm
                </button>
              </form>
            </div>
          </div>
